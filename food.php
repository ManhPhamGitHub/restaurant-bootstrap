...
<body>
            ...
            <table class="table table-sm table-borderless align-middle">
                ...
                <tbody>
                    <tr>
                        ...
                        <td> 5$</td>
                        <td><img src="./img/3.jpg" width="100" height="150" /></td>
                        <td>
                            <p>Yes</p>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td> 5$</td>
                        <td><img src="./img/4.jpg" width="100" height="150" /></td>
                        <td>
                            <p>Yes</p>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td> 5$</td>
                        <td><img src="./img/5.jpg" width="100" height="150" /></td>
                        <td>
                            <p>Yes</p>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td> 999$</td>
                        <td><img src="./img/6.jpg" width="100" height="150" /></td>
                        <td>
                            <p>Yes</p>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td> 1$</td>
                        <td><img src="./img/7.jpg" width="100" height="150" /></td>
                        <td>
                            <p>Yes</p>
                        </td>
                        <td>
    ...
    <!-- Copy right -->
    <div class="bg-danger">
        <p class="text-center py-3 text-light">2020 All right reserved , Food House . Developed By <span><a
                    href="https://github.com/ManhPhamGitHub">Manh Pham</a></span></p>
    </div>
